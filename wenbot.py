...
def main():
    ...
    # Schedule Jobs
    scheduler.add_job(video_engine.process_video, 'interval', minutes=5, id='viral_video_gen', replace_existing=True)
    scheduler.add_job(pseo_engine.build_pages, 'interval', minutes=5, id='seo_regen', replace_existing=True)
